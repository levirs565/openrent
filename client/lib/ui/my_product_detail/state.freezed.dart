...
mixin _$MyProductDetailState {
 ...
 int get id; bool get isLoading; MyProductResponseItemDetail? get data; GeneralErrorData? get error;
...
@useResult
$Res call({
 MyProductResponseItemDetail? data, ErrorData<void>? error, int id, bool isLoading
});
