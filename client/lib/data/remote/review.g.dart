...
class _ReviewService implements ReviewService {
  ...
  @override
  Future<List<ProductReviewDetail>> getReviews(int productId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ProductReviewDetail>>(
    ...
    late List<ProductReviewDetail> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
