...
ProductRentRequest _$ProductRentRequestFromJson(Map<String, dynamic> json) =>
    ProductRentRequest(
...
Map<String, dynamic> _$ProductRentRequestToJson(ProductRentRequest instance) =>
    <String, dynamic>{
...
class _RentService implements RentService {
  _RentService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<ActionResponse> rent(int productId, ProductRentRequest request) async {
