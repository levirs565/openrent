...
func NewService(fcmClient *messaging.Client, db *gorm.DB) *Service {
	return &Service{fcmClient: fcmClient, db: db}
}
...
func (s *Service) SendNotification(ctx context.Context, userId uint, notification Notification) error {
